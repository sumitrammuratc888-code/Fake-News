...
/**
 * Login — User authentication component with email/password fields.
 * Connects to FastAPI backend for JWT token authentication.
 */

const API_URL = import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/api/auth/login` : 'http://localhost:8000/api/auth/login'
      ...
      <div className="glass-strong neon-border p-8 rounded-2xl max-w-md w-full animate-fade-in-up border border-white/10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-inter text-sm">
            Access your AI-powered truth dashboard
          </p>
        </div>
